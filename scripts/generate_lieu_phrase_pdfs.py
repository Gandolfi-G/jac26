...
ITEMS = [
    ...
    ("Salle 111", "Lucas a trouvé une clé près d’une table. Transmettez ce prénom au QG."),
    ...
    ("Salle de Jean-Philippe", "Clara a posé une question juste avant la sonnerie. Transmettez ce prénom au QG."),
...
SLUGS = {
    ...
    "Salle de Jean-Philippe": "salle_de_jean_philippe",
